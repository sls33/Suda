...
void test_encrypt_decrypt_idlabels()
{
    ...
    std::vector<string> id_tables = { "edd",  "dsvfdv", "grf8", "de3e3", "cdfef", "bfe4",
                                      "lkjh", "jit9",   "fd9i", "lkg9",  "ddw2" };
    std::vector<string> batch_ids = { "edd",  "dsvfdv", "de3e3", "cdfef", "tret",
                                      "bfe4", "fd9i",   "lkg9",  "ddw2",  "lkjh" };
    std::vector<bool> batch_labels = { true,  false, false, false, true,
